...
import { chBuzon,chBuzon2,chTravel2, chIntesity,chRoom } from '../Slice/Theme';
...
export function Room3(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/seconsEsV2.glb");
  const { actions } = useAnimations(animations, group);
  const [scaleRoom,setScaleRoom]=useState(0)
  const [on,setOn]=useState(false)
  const [poyRoom,setposyRoom]=useState(0)
  ...
  return (
    <group ref={group} {...props} dispose={null} position={[poyRoom,-1,-10]} scale={scaleRoom}>
      <group name="Scene">
        <mesh
          name="cablepared"
          castShadow
        ...
        <mesh
          ...
          material={materials.carga}
          position={[0.24, -0.2, -2.6]}
          scale={[0.52, 0.1, 0.52]}
        />
        <group
          name="energy002"
          position={[0.24, -0.71, -2.6]}
          scale={[0.52, 0.1, 0.52]}
        >
          <mesh
            name="Cube002"
        ...
        >
        {
            on ?<Html castShadow className='page-li'  scale={0.12} rotation-x={-Math.PI / 2} rotation-z={Math.PI/2} position={[0.1, 0, -0.1]}   receiveShadow occlude="blending" transform style={{border: "5px"}} >
...
useGLTF.preload("/seconsEsV2.glb");
